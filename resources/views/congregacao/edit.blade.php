...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header fs-5 fw-bold">{{ __('Editar Congregação - ID: ') }}{{ $congregacao->id}}</div>
                <div class="card-body">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('congregacao.show', ['congregacao' => $congregacao->id]) }}" class="btn btn-sm btn-warning mx-3">Cancelar</a>
                </div>
            </div>
        </div>
    </div>
