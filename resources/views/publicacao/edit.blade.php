                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('publicacao.update', ['publicacao' => $publicacao->id]) }}" enctype="multipart/form-data" id="formUpdate">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="proporcao_cm" type="number" step="0.5" class="form-control @error('proporcao_cm') is-invalid @enderror" name="proporcao_cm" value="{{ $publicacao->proporcao_cm ?? old('proporcao_cm') }}" autocomplete="proporcao_cm" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="proporcao_unidade" type="number" class="form-control @error('proporcao_unidade') is-invalid @enderror" name="proporcao_unidade" value="{{ $publicacao->proporcao_unidade ?? old('proporcao_unidade') }}" autocomplete="proporcao_unidade" autofocus>
