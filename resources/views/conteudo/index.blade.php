                        ...
                        <tbody>
                            @foreach ($conteudos as $key => $c) 
                                <tr>
                                    ...
                                    <td class="py-0 text-center" scope="row">{{$c->quantidade}}</td>
                                    <td class="py-0 text-center" scope="row">{{$c->publicacao->nome}}</td>
                                    <td class="py-0 text-center" scope="row">{{$c->volume->volume}}</td>
