        ...
        <div class="col-md-8">
            <div class="card">
                <form method="POST" action="{{ route('user.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-header fs-5">{{ __('Adicionar Usuario') }}</div>
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-text">{{ __('Senha') }}</span>
                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-text">{{ __('Confirme a Senha') }}</span>
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                        </div>
                        <hr>
                        <p class="fs-5">Permissões</p>
